...
public class Console {
	...
	public Console(String endpoint) {
		super();
	...
	public void execute(String[] args) {
		...
		try {
			...
			if (command.equals("start")) {
				...
				processConnect(args, true);
			} else if (command.equals("listen")) {
				processConnect(args, false);
			...
			System.out.println("Connection timeout occurred with server at " + endpoint);
		}
	}
	...
	private void processHelp() {
		...
		System.out.println("\t<name> start   <args>");
		System.out.println("\t<name> test    <args>");
		System.out.println("\t<name> stop    [id]");
		System.out.println("\t<name> kill    [id]");
		System.out.println("\t<name> connect");
		System.out.println("\t<name> listen");
	...
	public static void main(String[] args) {
		...
		try {
			...
			console.execute(applicationArgs);
